...
export default function AboutSection() {
  ...
  const stats = [
    { icon: Award, value: "10+", label: "Projects Completed", color: "text-accent" },
    { icon: Coffee, value: "3+", label: "Month Experience", color: "text-success" },
    { icon: Users, value: "90%", label: "Happy Clients", color: "text-yellow-500" },
  ...
  return (
    <section id="about" className="py-0 px-4 bg-muted/30 relative overflow-hidden" ref={ref}>
      {/* Background Pattern */}
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          >
            ...
            <motion.div variants={itemVariants} className="space-y-6 text-muted-foreground leading-relaxed">
              <p className="text-lg">
                I’m a passionate web developer starting my journey, with hands-on experience from a 2-month internship. I’ve worked on real-world projects, building responsive and user-friendly applications.
              </p>
              <p className="text-lg">
                I love exploring new technologies, sharpening my skills, and staying updated with design trends. I'm excited to grow further and contribute to meaningful projects.
              </p>
            ...
            >
              ...
              <div className="flex flex-wrap gap-3">
                {["React", "Node.js", "JavaScript", "Figma", "MongoDB"].map((skill, index) => (
                  <motion.span
                    key={skill}
