  ...
  const skillCategories = [
    {
      ...
      skills: [
        { name: "React.js", level: 75, color: "bg-accent" },
        { name: "JavaScript", level: 75, color: "bg-accent" },
        { name: "Tailwind CSS", level: 75, color: "bg-accent" },
    ...
    },
    {
      ...
      skills: [
        { name: "Node.js", level: 70, color: "bg-yellow-600" },
        { name: "Express.js", level: 85, color: "bg-yellow-600" },
        { name: "REST APIs", level: 88, color: "bg-yellow-600" },
        { name: "MongoDB", level: 80, color: "bg-yellow-600" },
      ]
    },

    {
      ...
      skills: [
        ...
        { name: "Github", level: 90, color: "bg-purple-400" },
      ]
    }
  ];

  const tools = [
    "VS Code", "Postman", "Vercel", "GitHub", "Render", "Vite",
  ];
